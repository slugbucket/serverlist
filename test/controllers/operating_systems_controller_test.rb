...
class OperatingSystemsControllerTest < ActionController::TestCase
  ...
  test "should create operating_system" do
    assert_difference('OperatingSystem.count') do
      post :create, operating_system: { description: @operating_system.description, expiry: @operating_system.expiry, name: @operating_system.name }
    end
  ...
  test "should update operating_system" do
    patch :update, id: @operating_system, operating_system: { description: @operating_system.description, expiry: @operating_system.expiry, name: @operating_system.name }
    assert_redirected_to operating_system_path(assigns(:operating_system))
  end
